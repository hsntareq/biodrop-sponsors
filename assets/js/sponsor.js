/******/ (() => {
  ...
  \***************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ multipleElement: () =>
            /* binding */ multipleElement,
          /* harmony export */ nameElement: () => /* binding */ nameElement,
          /* harmony export */ toogleDisabler: () =>
            /* binding */ toogleDisabler,
          /* harmony export */ toogleInputValue: () =>
            /* binding */ toogleInputValue,
  ...
  \*******************************/
    __webpack_require__.r(__webpack_exports__);
    /* harmony import */ var _lib__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(/*! ./lib */ "./assets/src/lib.js");
    // const protocolForm = singleElement(".protocol_form");

    let toggles = (0, _lib__WEBPACK_IMPORTED_MODULE_0__.multipleElement)(
    ...
    const present_item = (0, _lib__WEBPACK_IMPORTED_MODULE_0__.multipleElement)(
      ".preset-item"
    );

    if (present_item) {
      Array.from(
        (0, _lib__WEBPACK_IMPORTED_MODULE_0__.multipleElement)(".preset-item")
      ).forEach(
        (elm) =>
          (elm.onclick = (e) => {
            console.log(elm.dataset.preset);
            let presetName = elm.dataset.preset;
            Array.from(present_item).forEach((el) =>
              ...
              if (xhttp.readyState === 4) {
                ...
                if (getData.data) {
                  Object.entries(getData.data).forEach(([key, value]) => {
                    var fieldValue = (0,
                    _lib__WEBPACK_IMPORTED_MODULE_0__.nameElement)(key);

                    if (0 !== fieldValue.length) {
                      (0, _lib__WEBPACK_IMPORTED_MODULE_0__.nameElement)(
                        key
                      )[0].value = value;
                    }
                  });
                ...
                (0, _lib__WEBPACK_IMPORTED_MODULE_0__.toastTrigger)(
                  "success",
                  'The "' +
    ...
    const protocolForm = (0, _lib__WEBPACK_IMPORTED_MODULE_0__.singleElement)(
      "#protocol_form"
    );
    ...
    if (protocolForm) {
      protocolForm.onsubmit = (e) => {
        ...
        xhttp.onreadystatechange = function () {
          if (xhttp.readyState === 4) {
            console.log("not working"); // var getData = JSON.parse(xhttp.response);

            console.log(xhttp.response); // console.log(getData.success);
    ...
    const updateProtocol = (0, _lib__WEBPACK_IMPORTED_MODULE_0__.singleElement)(
      "#update_protocol"
    ...
    if (updateProtocol) {
      updateProtocol.onclick = (e) => {
        var formData = new FormData(protocolForm);
        formData.append("action", "update_protocol"); // formData.append("protocol_id", update_id);
        ...
        xhttp.onreadystatechange = function () {
          if (xhttp.readyState === 4) {
            ...
            if (getData.success == false) {
              ...
              (0, _lib__WEBPACK_IMPORTED_MODULE_0__.toastTrigger)(
                "success",
                "The protocol is updated successfully"
              );
            }
          }
        };
    ...
    const deleteProtocol = (0, _lib__WEBPACK_IMPORTED_MODULE_0__.singleElement)(
      "#delete_protocol"
          ...
          xhttp.onreadystatechange = function () {
            if (xhttp.readyState === 4) {
              ...
              if (getData.success == true) {
                (0, _lib__WEBPACK_IMPORTED_MODULE_0__.toastTrigger)(
                  "success",
                  "The protocol is deleted successfully"
                );
                const url = new URL(window.location);
                console.log(url.origin + url.pathname);
                let page = url.searchParams.get("page");
    ...
    const selectProtocol = (0, _lib__WEBPACK_IMPORTED_MODULE_0__.singleElement)(
      "#select_protocol"
    );
